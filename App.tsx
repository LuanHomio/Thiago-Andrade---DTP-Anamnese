  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center animate-fadeIn">
        ...
        <p className="text-xl text-brand-darkGrey">
          Agora é hora de começar.
        </p>
        <button 
          onClick={() => window.location.reload()}
          className="mt-8 text-brand-red font-semibold hover:underline"
        >
  ...
  return (
    <div className="min-h-screen bg-white text-brand-black">
      ...
      <header className="bg-brand-black text-white py-8 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-2 text-white">
            DESAFIO <span className="text-brand-red">TCHAU PANÇA</span>
          </h1>
      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        <form onSubmit={handleSubmit} className="space-y-2">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="w-full">
                <label className="block text-brand-black font-medium mb-1">Sexo</label>
                <select 
                  name="sex" 
                  value={formData.sex} 
                  onChange={handleChange}
          ...
          <Section 
            ...
            description="📸 Recomendado, mas opcional. Use roupa similar, mesmo local e sem pose. Mesmo que você não envie agora, tente registrar suas fotos."
            icon={
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-brand-lightGrey mb-8">
            ...
            <label className="flex items-start cursor-pointer group">
              ...
              <span className="ml-3 text-brand-darkGrey leading-tight group-hover:text-brand-black transition-colors">
                Me comprometo a seguir o plano do Desafio Tchau Pança pelos próximos 21 dias e fazer o meu melhor. <span className="text-brand-red">*</span>
              </span>
            </label>
          </div>
      ...
      <footer className="py-8 text-center text-gray-400 text-sm border-t border-brand-lightGrey">
        <p>© {new Date().getFullYear()} Desafio Tchau Pança. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
}
